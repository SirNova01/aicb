<?php
  ...
  if(isset($_POST['start'])){
    ...
    $other_names =  mysqli_real_escape_string($db_handle, $_POST['other_names']);
    ...
    if (empty($other_names)) { array_push($errors, "Other Names is required"); }
    ...
    if (count($errors) == 0) {
      ...
      $register_query = "INSERT INTO users ( user_id, 	first_name, other_names,	  email,	   phone,	password,	     ref_code, referrer,  	 evs,	       evc,                         	lcdt,	account_verification_status,     account_type,	reg_date,	reg_day,	last_login_date,	last_login_day ) 
                                    VALUES('$user_id',  '$first_name', '$other_names', '$email','$phone', '$enc_password',      '',  '$ref_code','not_verified', '$email_verification_code',    '$date',  'not_verified',      'user',     '',  '',   '',  '' )";
                              ...
                              <div class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                 <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-6 offset-lg-3 xs-12">
                                    <div class="sectionTitlestyle__SectionTitleWrapper-lzdnsw-0 fjPqRn title__wrapper">
                                       <h1 class="Heading__HeadingWrap-sc-1tne3rx-0 kMvOWj heading"> Sign Up </h1>
                                       <p class="Text__TextWrapper-sc-5ha4qu-0 cOKoiv text">Already have an account? <b> <a href="signin"> Sign In</a></b> </p>
                                    </div>
                                 </div>
                              </div>
                              <form method="post" action="start">
                                ...
                                <div class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        ...
                                        <div class="inputstyle__InputWrapper-x4q24z-0 eBaPLn input__wrapper"><input name="first_name" type="text" placeholder="First Name"/></div>
                                ...
                                <div style="margin-top:-40px;" class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                                        <div class="inputstyle__InputWrapper-x4q24z-0 eBaPLn input__wrapper"><input name="other_names" type="text" placeholder="Other Names"/></div>
                                ...
                                <div style="margin-top:-40px;" class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                                        <div class="inputstyle__InputWrapper-x4q24z-0 eBaPLn input__wrapper"><input name="email" type="email" placeholder="Email"/></div>
                                ...
                                <div style="margin-top:-40px;" class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                                        <div class="inputstyle__InputWrapper-x4q24z-0 eBaPLn input__wrapper"><input name="password" type="password" placeholder="Password"/></div>
                                ...
                                <div style="margin-top:-40px;" class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                                        <div class="inputstyle__InputWrapper-x4q24z-0 eBaPLn input__wrapper"><input name="phone" type="text" placeholder="Phone Number"/></div>
                                ...
                                <div style="margin-top:-40px;" class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                                        <div class="inputstyle__InputWrapper-x4q24z-0 eBaPLn input__wrapper"><input name="ref_code" type="text" placeholder="Referral Code"/></div>
                                ...
                                <div style="margin-top:-40px;" class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                                    <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                                        <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                                            <button name="start" type="submit" class="buttonstyle__ButtonWrapper-vboqqy-0 khusAO btn">Sign In</button>
                                        </div>
                                    </div>
                                </div>
                              </form>
