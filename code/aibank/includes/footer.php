                     ...
                     <div class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                        <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-6 offset-lg-3 xs-12">
                           <div class="sectionTitlestyle__SectionTitleWrapper-lzdnsw-0 fjPqRn title__wrapper">
                              <h1 class="Heading__HeadingWrap-sc-1tne3rx-0 kMvOWj heading"> Don’t miss out, Stay updated </h1>
                              <p class="Text__TextWrapper-sc-5ha4qu-0 cOKoiv text">Sign up for updates and market news. Subscribe to our newsletter and receive update about ICOs and crypto tips.</p>
                           </div>
                        </div>
                     </div>
                     <div class="rowstyle__RowWrapper-sc-1nreibv-0 ljhoKP row">
                        <div class="colstyle__ColWrapper-sc-1oqivd3-0 cSKItV col lg-8 offset-lg-2 xs-12">
                           <div class="Box__BoxWrapper-sc-9qo6sy-0 hHLgFu box form-box">
                              ...
                              <button class="buttonstyle__ButtonWrapper-vboqqy-0 khusAO btn">Subscribe</button>
                           </div>
                        </div>
                     </div>
                  </div>
